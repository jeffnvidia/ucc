...
typedef struct ucc_tl_ucp_task {
    ...
    union {
        ...
        struct {
            ...
            ucc_rank_t sample_start_completed;
            ...
            uint8_t    progress_profile;
            uint8_t    progress_profile_logged;
            uint8_t    refill_pending;
            double     start_time;
            ...
            uint32_t   max_send_burst;
            uint32_t   max_recv_burst;
            uint32_t   send_drain_events;
            uint32_t   recv_drain_events;
